...
PARLIAMENT_PERIOD_ID = 155  # EU-Parlament 2024 - 2029
TARGET_LIST_LABEL = "Landesliste Berlin"
TARGET_LIST_ID = 603

DATA_SOURCES_DIR = r"C:\Users\jermo\Documents\BERLINMAP\berlinwahl2026\data-sources"
FULL_OUT = DATA_SOURCES_DIR + r"\EU_2025_by_Landesliste_full.csv"
TRUTH_OUT = DATA_SOURCES_DIR + r"\EU_2025_by_Landesliste_truth.csv"
...
def is_target_list(electoral_list):
    if not electoral_list:
        return False
    list_id = electoral_list.get("id")
    label = (electoral_list.get("label") or "").lower()
...
def main():
    ...
    if not period:
        print("ERROR: EU parliament period not found.")
        sys.exit(1)
